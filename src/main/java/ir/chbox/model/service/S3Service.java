...
//        s3.createBucket(bucketName);
        ...
        System.out.println();
             ...
             */
        File file = File.createTempFile("aws-java-sdk-", ".jpeg");
        file.deleteOnExit();
        ...
        s3.putObject(new PutObjectRequest("challengebox", key, file));
