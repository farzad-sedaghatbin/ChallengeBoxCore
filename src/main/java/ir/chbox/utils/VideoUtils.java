...
public class VideoUtils {
    ...
    int setupStreams() {
        String inputURL = "/home/farzad/Downloads/test.mp4";
        String outputURL = "/home/farzad/Downloads/feritest.mp4";
        ...
        String acodec = "mp3float";
        String vcodec = "h261";
        String containerFormat = "mov";
        int astream = -1;
        int aquality = 0;
        ...
        String icontainerFormat = "mov";
        String iacodec = "mp3float";
        int isampleRate = 0;
        int ichannels = 0;
...
*/
                ...
                System.out.println("Ignoring input stream {} of type {}" + i + cType);
            }
